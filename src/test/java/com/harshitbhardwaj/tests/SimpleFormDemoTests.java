...
import com.harshitbhardwaj.pages.SimpleFormDemoPage;
...
public class SimpleFormDemoTests extends Base {

    final String expectedFailureMessage = "Entered value is not a number";
    WebDriver driver;
